...
public class RescueeActivity extends AppCompatActivity implements Callback<UserId> {
    ...
    /**
     * Simple permission request number referring to all required user permissions.
     */
    int PERMISSION_ALL = 1;

    /**
     * Array of all required user positions.
     */
    ...
    /**
     * Helper method. Used to determine if activity has all required permissions.
     *
